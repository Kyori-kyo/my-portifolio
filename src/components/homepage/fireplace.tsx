	...
	return (
		<div className={"flex flex-col relative"} id="homePage">
			<div className={"generalPageAlign gap-5 z-10 bg-black/40 md:px-64"}>
				...
				<h1
					className={"md:text-4xl text-xl font-semibold typewriter max-w-fit"}
				>
					{t("hi")}
					<span className={"text-orange-400"}>! </span>
					{t("me", { name: "Ríchard Lucas" })}
				</h1>
				...
				<div className={"flex flex-col gap-5"}>
					...
					<div>
						{t("email")}{" "}
						<a
							className={"hover:text-white text-orange-400 underline"}
			...
			<div
				id="Fireplace"
				className={"w-full h-screen overflow-hidden absolute"}
			>
				<video
					...
					preload="auto"
				>
					<source src="/assets/videos/fireplaceOverSea.mp4" type="video/mp4" />
