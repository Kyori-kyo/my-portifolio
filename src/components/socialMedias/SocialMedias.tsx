...
const SocialMedias = () => {
	...
	return (
		<div
			id="footer"
			className={
				"flex flex-col items-center justify-center gap-5 z-20 fixed bottom-5 left-5 md:bottom-10 md:left-10 "
			}
		>
			<div className={"flex flex-col items-center justify-center relative"}>
				<a
					...
					target="blank"
					className={clsx(
						"rounded-full hover:scale-110 absolute transition-transform duration-300",
						submenuVisible
							? "translate-y-[2.63rem]"
							: "-translate-y-[108px] ease-in-out",
					)}
				>
					<SvgTwitter />
				</a>
